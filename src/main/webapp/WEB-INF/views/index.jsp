    ...
    <main>
        ...
        <div class="content_area">
            <div class="department_info">
                ...
                <p><i class="fas fa-clock"></i> 업데이트 날짜 : <span><fmt:formatDate value="${update.department}" pattern="yyyy년 MM월 dd일 (EE) HH:mm:ss"/></span></p>
            </div>
            <div class="teacher_info">
                ...
                <p><i class="fas fa-clock"></i> 업데이트 날짜 : <span><fmt:formatDate value="${update.teacher}" pattern="yyyy년 MM월 dd일 (EE) HH:mm:ss"/></span></p>
            </div>
